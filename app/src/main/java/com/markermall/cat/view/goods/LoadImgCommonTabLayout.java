package com.markermall.cat.view.goods;
 ...
 */
public class LoadImgCommonTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener, ViewPager.OnPageChangeListener {
    private Context mContext;
    private ArrayList<LoadImgCustomTabEntity> mTabEntitys = new ArrayList<>();
    ...
    public LoadImgCommonTabLayout(Context context) {
        this(context, null, 0);
    }

    public LoadImgCommonTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadImgCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setTabData(ArrayList<LoadImgCustomTabEntity> tabEntitys) {
     ...
     * 关联数据支持同时切换fragments
     */
    public void setTabData(ArrayList<LoadImgCustomTabEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
...
//        iv_tab_icon.setImageResource(mTabEntitys.get(position).getTabUnselectedIcon());
        LoadImgUtils.setImg(mContext, iv_tab_icon, mTabEntitys.get(position).getTabUnselectedIcon());
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                LoadImgCustomTabEntity tabEntity = mTabEntitys.get(i);

                LoadImgUtils.setImg(mContext, iv_tab_icon, i == mCurrentTab ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private void calcIndicatorRect() {
        ...
        TextView tv_tab_title = (TextView) currentTabView.findViewById(R.id.tv_tab_title);
//            float indicatorLeft = currentTabView.getLeft() + (tv_tab_title.getWidth() - mIndicatorWidth) / 2;
        float indicatorLeft = currentTabView.getLeft() + (currentTabView.getWidth() - tv_tab_title.getWidth() - mIndicatorWidth) / 2;

        mIndicatorRect.left = (int) indicatorLeft;
        mIndicatorRect.right = (int) (mIndicatorRect.left + tv_tab_title.getWidth() + mIndicatorWidth);
