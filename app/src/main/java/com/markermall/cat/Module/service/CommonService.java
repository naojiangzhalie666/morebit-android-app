...
import com.markermall.cat.pojo.AccountDestroy;
import com.markermall.cat.pojo.AgentDetailList;
...
import com.markermall.cat.pojo.CheckWithDrawBean;
import com.markermall.cat.pojo.CircleBrand;
...
import com.markermall.cat.pojo.FansInfo;
...
import com.markermall.cat.pojo.ShareUrlBaen;
...
import com.markermall.cat.pojo.UserFeedback;
import com.markermall.cat.pojo.UserInfo;
import com.markermall.cat.pojo.UserscoreBean;
import com.markermall.cat.pojo.VipUseInfoBean;
import com.markermall.cat.pojo.goods.BandingAliRelationBean;
import com.markermall.cat.pojo.goods.CheckCouponStatusBean;
import com.markermall.cat.pojo.goods.CouponUrlBean;
...
import com.markermall.cat.pojo.goods.ShareUrlListBaen;
import com.markermall.cat.pojo.goods.ShareUrlStringBaen;
import com.markermall.cat.pojo.goods.TKLBean;
import com.markermall.cat.pojo.home.ByItemSourceIdBean;
import com.markermall.cat.pojo.home.SysNoticeBean;
import com.markermall.cat.pojo.home.TmallActivityBean;
...
import com.markermall.cat.pojo.myInfo.OssKeyBean;
import com.markermall.cat.pojo.request.ClassroomBean;
import com.markermall.cat.pojo.request.RequestALiCodeBean;
import com.markermall.cat.pojo.request.RequestAppFeedBackBean;
import com.markermall.cat.pojo.request.RequestArticleBean;
...
import com.markermall.cat.pojo.request.RequestBindWxBean;
...
import com.markermall.cat.pojo.request.RequestCheckPhoneNumBean;
import com.markermall.cat.pojo.request.RequestCircleBransBean;
import com.markermall.cat.pojo.request.RequestCircleCollectBean;
...
import com.markermall.cat.pojo.request.RequestCouponUrlBean;
import com.markermall.cat.pojo.request.RequestFansInfoBean;
...
import com.markermall.cat.pojo.request.RequestGoodsListByIdBean;
...
import com.markermall.cat.pojo.request.RequestMarkermallCircleBean;
...
import com.markermall.cat.pojo.request.RequestPushBean;
...
import com.markermall.cat.pojo.request.RequestReleaseCategory;
...
import com.markermall.cat.pojo.request.RequestRemarkBean;
import com.markermall.cat.pojo.request.RequestRemoveCircleCollectBean;
import com.markermall.cat.pojo.request.RequestReplyBean;
...
import com.markermall.cat.pojo.request.RequestSplashStatistics;
import com.markermall.cat.pojo.request.RequestSystemNoticeBean;
import com.markermall.cat.pojo.request.RequestTKLBean;
import com.markermall.cat.pojo.request.RequestTeanmListBean;
import com.markermall.cat.pojo.request.RequestTmallActivityLinkBean;
import com.markermall.cat.pojo.request.RequestUpPasswordBean;
import com.markermall.cat.pojo.request.RequestUpdateHeadPortraitBean;
import com.markermall.cat.pojo.request.RequestUpdateNewPhoneBean;
import com.markermall.cat.pojo.request.RequestUserInfoBean;
import com.markermall.cat.pojo.request.RequestVaultListBean;
import com.markermall.cat.pojo.request.RequestVideoId;
import com.markermall.cat.pojo.request.RequestWechatCodeBean;
import com.markermall.cat.pojo.request.RequestWeixiLoginBean;
import com.markermall.cat.pojo.request.RequestWhatLike;
import com.markermall.cat.pojo.request.base.RequestBaseTypeBean;
import com.markermall.cat.pojo.requestbodybean.RequestAnalysisTKL;
import com.markermall.cat.pojo.requestbodybean.RequestCheckWithdrawBean;
...
import com.markermall.cat.pojo.requestbodybean.RequestGetTimedSpikeList;
...
import com.markermall.cat.pojo.requestbodybean.RequestOfficialNoticeBean;
import com.markermall.cat.pojo.requestbodybean.RequestOfficialRecommend;
import com.markermall.cat.pojo.requestbodybean.RequestOsBean;
import com.markermall.cat.pojo.requestbodybean.RequestPage;
import com.markermall.cat.pojo.requestbodybean.RequestShareGoods;
...
import com.markermall.cat.pojo.requestbodybean.RequestThreeGoodsClassify;
import com.markermall.cat.pojo.requestbodybean.RequestTwoLevel;
import com.markermall.cat.pojo.requestbodybean.RequestUploadCouponInfo;
import com.markermall.cat.pojo.requestbodybean.RequestWithdrawBean;
