package com.markermall.cat.main.ui.myview.xtablayout;
            ...
            if (mCustomView == null) {
                ...
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(R.layout.view_home_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                ...
                canvas.drawRoundRect(rectF, 20,20, mSelectedIndicatorPaint); //先绘制圆角矩形
