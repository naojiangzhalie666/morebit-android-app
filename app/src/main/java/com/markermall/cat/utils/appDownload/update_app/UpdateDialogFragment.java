package com.markermall.cat.utils.appDownload.update_app;
...
import com.markermall.cat.utils.appDownload.update_app.listener.ExceptionHandler;
import com.markermall.cat.utils.appDownload.update_app.listener.ExceptionHandlerHelper;
import com.markermall.cat.utils.appDownload.update_app.listener.IUpdateDialogFragmentListener;
import com.markermall.cat.utils.appDownload.update_app.service.DownloadService;
import com.markermall.cat.utils.appDownload.update_app.utils.AppUpdateUtils;
import com.markermall.cat.utils.appDownload.update_app.view.NumberProgressBar;
...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundColor(ContextCompat.getColor(getActivity(),R.color.top_head ));
        mNumberProgressBar.setProgressTextColor(ContextCompat.getColor(getActivity(),R.color.top_head ));
        mNumberProgressBar.setReachedBarColor(ContextCompat.getColor(getActivity(),R.color.top_head ));
        //随背景颜色变化
//        mUpdateOkButton.setTextColor(ColorUtil.isTextColorDark(color) ? ContextCompat.getColor(getActivity(),R.color.top_head ): Color.WHITE);
    }
    ...
    private void startDownloadApp(DownloadService.DownloadBinder binder) {
        ...
        if (mUpdateApp != null) {
            ...
            binder.start(mUpdateApp, new DownloadService.DownloadCallback() {
                ...
                //  这里的 onFinish 和 onInstallAppAndAppOnForeground 会有功能上的重合，后期考虑合并优化。
                @Override
