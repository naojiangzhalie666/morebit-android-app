...
import com.markermall.cat.Module.common.Activity.SimpleSinglePaneActivity;

/**
 * Created by fengrs on 2018/8/21.
 *  订单投诉
 */

public class LoadComplaintOrderActivity extends SimpleSinglePaneActivity {

    private String mFragment;
    private Fragment fragment;

    public static void start(Context context, String fragmentClass, Bundle extras) {
        Intent intent = new Intent(context, LoadComplaintOrderActivity.class);
        if (extras != null) {
