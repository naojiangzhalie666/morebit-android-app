...
public class MiYuanCircleInfo {
    ...
    public void setCircleBrands(List<MiYuanCircleInfo> circleBrands) {
    ...
    public void setShareRangItems(List<MiyuanCircleItemInfo> shareRangItems) {
