...
public class KeyboardUtil {
    ...
    public static boolean saveKeyboardHeight(Context context, int keyboardHeight) {
        ...
        SharedPreferencesUtils.put(context,"keyboardHeight",keyboardHeight);
        return true;
    }
    ...
    public static int getKeyboardHeight(Context context) {
        if(LAST_SAVE_KEYBOARD_HEIGHT == 0) {
            LAST_SAVE_KEYBOARD_HEIGHT = (int) SharedPreferencesUtils.get(context,"keyboardHeight",getMinPanelHeight(context.getResources()));
        }
