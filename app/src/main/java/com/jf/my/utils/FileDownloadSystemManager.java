...
public class FileDownloadSystemManager {
    private DownloadManager downloadManager;
    private Context context;
    private static FileDownloadSystemManager instance;

    private FileDownloadSystemManager(Context context) {
        downloadManager = (DownloadManager) context.getSystemService(Context.DOWNLOAD_SERVICE);
        this.context = context.getApplicationContext();
    }

    public static FileDownloadSystemManager getInstance(Context context) {
        if (instance == null) {
            instance = new FileDownloadSystemManager(context);
        }
        return instance;
    }
    /**
     ...
     * @return download id
     */
    public long startDownload(String uri, String title, String description,File savePath) {
        DownloadManager.Request req = new DownloadManager.Request(Uri.parse(uri));
//        req.setAllowedNetworkTypes(DownloadManage.Request.NETWORK_WIFI);
...
//        req.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, appName+".apk");
        ...
        //第三种 自定义文件路径
        req.setDestinationUri(Uri.fromFile(savePath));
     ...
     * @return file path
     * @see FileDownloadSystemManager#getDownloadUri(long)
     */
     ...
     * @param downloadId an ID for the download, unique across the system.
     *                   This ID is used to make future calls related to this download.
     * @see FileDownloadSystemManager#getDownloadPath(long)
     */
