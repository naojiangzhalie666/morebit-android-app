...
public class MyGsonUtils {
    ...
    public static List<MiYuanCircleInfo> toMiYuanCircleInfo(List<CircleBrand> datas) {
        List<MiYuanCircleInfo> miYuanCircleInfos = new ArrayList<>();
        for (int i = 0; i < datas.size(); i++) {
            ...
            miYuanCircleInfo.setPicture(pics);
            ...
            miYuanCircleInfos.add(miYuanCircleInfo);
        }

        return  miYuanCircleInfos;
    }
