...
import com.jf.my.login.myZxing.QRCodeDecoder;
...
//                //调用系统图库，选择图片
            ...
            case R.id.iv_back:
                finish();
//                getInviteCode("http://a.app.qq.com/o/simple.jsp?pkgname=com.jf.my&inviteCode=ljxnbq&invite=ljxnbq&token=zhitu_uSVnYLWLeGpk");
                break;
        }
    }
