 ...
 */
public class MiYuanHeadRefresh extends InternalAbstract implements RefreshHeader {
    ...
    public MiYuanHeadRefresh(Context context) {
        this(context, null);
    }

    public MiYuanHeadRefresh(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MiYuanHeadRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
