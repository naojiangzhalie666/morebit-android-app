...
import com.jf.my.Module.common.Dialog.OpenPushDialog;
import com.jf.my.Module.push.PushAction;
...
import com.jf.my.home.presenter.MainPresenter;
...
import com.jf.my.utils.fire.PermissionUtils;
import com.jf.my.utils.helper.ActivityLifeHelper;
import com.jf.my.view.GrayUpgradeDialog;
import com.jf.my.view.NoScrollViewPager;
import com.jf.my.view.main.SysNotificationView;
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                if (reason != null) {
                    if (reason.equals(SYSTEM_DIALOG_REASON_HOME_KEY)) {
                        MiYuanCircleAdapter.mShareCountId = 0;
