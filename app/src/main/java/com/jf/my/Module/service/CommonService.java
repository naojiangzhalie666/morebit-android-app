...
//    @FormUrlEncoded
    ...
    public Observable<BaseResponse<List<MiYuanCircleInfo>>> getMiYuanCircle(
            @Body RequestMiYuanCircleBean requestBean
//            @Field("type") int type,
//            @Field("page") int page
    );
    /**
    ...
    public Observable<BaseResponse<List<MiYuanCircleInfo>>> getMaterial(
            @Body RequestMiYuanCircleBean requestBean
    );
...
//    @FormUrlEncoded
    ...
    public Observable<BaseResponse> getMiYuanShareCount(
...
//            @Field("page") int page
    ...
    public Observable<BaseResponse<List<MiyuanInformation>>> getCarousel();
...
//    @FormUrlEncoded
    ...
    public Observable<BaseResponse<List<MiYuanCircleInfo>>> getCollectList(@Body RequestCircleBransBean requestBean);
    ...
    public Observable<BaseResponse<List<MiYuanCircleInfo>>> getCollectSearchList(@Body RequestCircleBransBean requestBean);
