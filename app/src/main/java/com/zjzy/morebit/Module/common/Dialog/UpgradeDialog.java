...
public class UpgradeDialog extends Dialog implements View.OnClickListener {
    ...
    private UpgradeDialog.OnListener mListener;
...
//        setContentView(R.layout.dialog_vip_upgrade);
    ...
    public UpgradeDialog setIcon(int resId) {
        ivIcon.setBackgroundResource(resId);
        return this;
    }

    public UpgradeDialog setContent(String text) {
        tvContent.setText(text);
        return this;
    }

    public UpgradeDialog setOnListner(UpgradeDialog.OnListener listener) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_right:
                if (mListener != null) {
                    mListener.onClick(UpgradeDialog.OnListener.RIGHT);
                }
                this.dismiss();
                break;
            case R.id.iv_icon:
                if (mListener != null) {
                    mListener.onClick(UpgradeDialog.OnListener.IMG);
                }
                this.dismiss();
                break;
        }
