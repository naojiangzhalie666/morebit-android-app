...
public class NumberReUseGridView extends LinearLayout {

    private LuRecyclerView mRecyclerView = null;
    private LuRecyclerViewAdapter lRecyclerViewAdapter;
    private NumberSwipeRefreshLayout swipeList;
   private  int  mColumn =1;
    private ImageView mGoTop;
    private RelativeLayout listview_rl;
    protected RecyclerView.OnScrollListener mExternalOnScrollListener;
    public NumberReUseGridView(Context context) {
        super(context);
        init(context);
    }

    public NumberReUseGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public NumberReUseGridView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context){
        ...
        View view = mInflater.inflate(R.layout.view_number_reusegridview,null);
        addView(view,new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        initView(view,context);
    }

    private void initView(View view, Context context){
        swipeList = (NumberSwipeRefreshLayout) view.findViewById(R.id.swipeList);
        ...
        swipeList.setOnRefreshListener(new NumberSwipeRefreshLayout.OnRefreshListener() {
            @Override
