package com.zjzy.morebit.view.refresh;
 ...
 */
public class NumberlHeadRefresh extends InternalAbstract implements RefreshHeader {
    ...
    public NumberlHeadRefresh(Context context) {
        this(context, null);
    }

    public NumberlHeadRefresh(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NumberlHeadRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        View view = LayoutInflater.from(context).inflate(R.layout.number_refresh_head, this);
