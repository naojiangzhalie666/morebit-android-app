...
/**
 * Created by fengrs on 2019/3/15.
 * 备注: 首页滑动的viewpger
 */
...
public class HomeMenuViewPagerView extends FrameLayout {
    ...
    public HomeMenuViewPagerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public HomeMenuViewPagerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            gridViewAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(ImageInfo imageInfo) {
                    if (null != mOnItemClickListener) {
                        mOnItemClickListener.onItemClick(imageInfo);
                    }
                }
            });
        }
    ...
    class GridViewAdapter extends BaseAdapter {
        ...
        public GridViewAdapter(Context context, List<ImageInfo> mDatas, int curIndex, int pageSize) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (imageInfo != null) {
                ...
                if (null != viewHolder.iv) {
                    LoadImgUtils.setImg(mContext, viewHolder.iv, imageInfo.getPicture());
                }
            }
    ...
    public interface OnItemClickListener {
        void onItemClick(ImageInfo position);
    }
