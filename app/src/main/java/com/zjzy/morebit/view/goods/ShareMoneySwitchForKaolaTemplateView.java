 ...
 * @date 2019/8/31
 */
public class ShareMoneySwitchForKaolaTemplateView extends LinearLayout {

    private MyAction.One<Integer> mAction;
    private ArrayList<ImageView> mImageViewArrayList;

    public ShareMoneySwitchForKaolaTemplateView(Context context) {
        this(context, null);
    }

    public ShareMoneySwitchForKaolaTemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
