...
public class CommercialShareDialog extends Dialog {
    ...
    private  int mType;
    ImageView iv_weChat,iv_weChat_circle,iv_weibo,iv_qq,iv_qq_room;
    TextView tv_weChat,tv_weChat_circle,tv_weibo,tv_qq,tv_qq_room;
    ImageButton iv_close;
    TextView title;
    public CommercialShareDialog(Context context, View.OnClickListener onClick) {
        super(context, R.style.dialog);
        mOnClick = onClick;
        mContext = context;
    }
    public CommercialShareDialog(Context context,int type, View.OnClickListener onClick) {
        super(context, R.style.dialog);
        mType= type;
        mOnClick = onClick;
        mContext = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_share_commercial);
    ...
    private void initView() {
        ...
        if(mType==1){
            ...
            iv_weibo.setImageResource(R.drawable.icon_video_weibo);
            ...
            tv_weibo.setTextColor(ContextCompat.getColor(mContext,R.color.white));
