 ...
 * 每日好货title
 * */
public class GoodDialyTitleAdapter2 extends RecyclerView.Adapter<GoodDialyTitleAdapter2.ViewHolder> {
    ...
    public GoodDialyTitleAdapter2(Context context, List<CategoryListChildDtos> mchild, int oneid, int circletype, int twoLevelId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.itme_dialy_title2, parent, false);
