...
public class SpaceItemRightUtils extends RecyclerView.ItemDecoration {
    ...
    public SpaceItemRightUtils(int space, int spanCount) {
        this.space = space;
        this.spanCount = spanCount;
    }
    public SpaceItemRightUtils(int space, int spanCount, @RecyclerView.Orientation int orientation) {
        this.space = space;
        this.spanCount = spanCount;
